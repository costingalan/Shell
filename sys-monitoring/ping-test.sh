...
# Set Variables
#
HOSTS="127.0.0.1"     							# DNS or IP of host(s) to be checked.                                
COUNT="5"                                               	# Number of ping request.
SUBJECT="Ping failed - Server(s) may be down"           	# Subject Head of Email.
EMAILID="galan.costin@gmail.com"                        	# Email address of Users to receive Notification.
##################################################
